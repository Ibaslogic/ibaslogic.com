...
featured: "/images/javascript-foreach/javascript-foreach.png"
draft: false
---
...
![Array forEach](/images/javascript-foreach/array-foreach.png)
...
![foreach thisValue](/images/javascript-foreach/foreach-thisValue.png)
