...
## [H3]Why not just use `arr[-1]` to access the last array element?
...
## [H3]Working with the returned value of a function
...
## [H3]The `.at()` method accepts numbers with a decimal
